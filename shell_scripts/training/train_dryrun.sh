...
DATA_DIR="/rds/general/user/amk125/home/delphi-amk125_model/data/ukb_amk125"
...
echo "Starting UKB AMK125 training at $(date)"
...
echo "UKB AMK125 training completed successfully at $(date)"
