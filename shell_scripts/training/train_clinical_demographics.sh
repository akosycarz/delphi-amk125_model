#!/bin/bash
#PBS -N train_clin_dem
#PBS -l select=1:ncpus=4:mem=32gb:ngpus=1
#PBS -l walltime=06:00:00
#PBS -j oe
#PBS -o /rds/general/user/amk125/ephemeral/logs/train_clinical_demographics.log

set -euo pipefail

PROJECT_DIR="/rds/general/user/amk125/home/delphi-amk125_model/Delphi"
DATA_DIR="/rds/general/user/amk125/home/delphi-amk125_model/data/ukb_amk125_clinical_demographics_icd"
PYTHON="/rds/general/user/amk125/home/anaconda3/envs/delphi/bin/python"
CONFIG="config/train_clinical_demographics_icd.py"

eval "$(~/anaconda3/bin/conda shell.bash hook)"
conda activate delphi

echo "Starting clinical and demographics training at $(date)"
...
echo "Clinical and demographics training completed successfully at $(date)"
