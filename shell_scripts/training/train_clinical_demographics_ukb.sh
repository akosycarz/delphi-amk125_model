...
#PBS -j oe
#PBS -o /rds/general/user/amk125/ephemeral/logs/train_clinical_demographics_ukb_icd.log

set -euo pipefail

PROJECT_DIR="${HOME}/delphi-amk125_model"
DATASET="ukb_amk125_clinical_demographics_ukb_icd"
CONFIG="config/train_ukb_amk125_clinical_demographics_ukb_icd.py"
