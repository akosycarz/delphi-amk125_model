#!/bin/bash
#PBS -N train_all_data
#PBS -l select=1:ncpus=4:mem=32gb:ngpus=1
#PBS -l walltime=08:00:00
#PBS -j oe
#PBS -o /rds/general/user/amk125/ephemeral/logs/train_all.log

set -euo pipefail

PROJECT_DIR="/rds/general/user/amk125/home/delphi-amk125_model/Delphi"
DATA_DIR="/rds/general/user/amk125/home/delphi-amk125_model/data/ukb_amk125_clinical_demographics_ukb_biochem_icd_self_reported"
PYTHON="/rds/general/user/amk125/home/anaconda3/envs/delphi/bin/python"
CONFIG="config/train_all.py"

eval "$(~/anaconda3/bin/conda shell.bash hook)"
conda activate delphi

echo "Starting all-data training at $(date)"
...
echo "All-data training completed successfully at $(date)"
